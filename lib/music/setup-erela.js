...
const { lavalinkPort } = require(process.cwd() + '/config.json')

module.exports = bot => {
  bot.manager = new Manager({
    nodes: [{ host: 'localhost', port: lavalinkPort, password: 'youshallnotpass', retryAmount: Infinity, retryDelay: 3000 }],
